package com.think.showcase.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.think.showcase.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.think.showcase.repository.UserRepository.USERS_BY_EMAIL_CACHE);
